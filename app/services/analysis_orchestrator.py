...
class AnalysisOrchestrator:
    ...
    async def _generate_analysis(
        self, claim_text: str, context: str, language: str, experiment: bool = False
        ...
        try:
            ...
            if language == "english":
                prompt = AnalysisPrompt.GET_VERACITY_EX if experiment else AnalysisPrompt.GET_VERACITY 
    ...
    async def analyze_claim_stream(self, claim_id: UUID, user_id: UUID, experiment: bool = False) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        try:
            ...
            async for chunk in self._generate_analysis(claim.claim_text, claim.context, claim.language, experiment=experiment):
